...
function incrementarPorUno(array) {
   ...
   // Tu código:
   return array.map(function(incremento){
      return incremento + 1;
   });
}
...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   var nuevoNumero = arrayOfNums.reduce(function(a, b) {
      return a + b;
   })
   return nuevoNumero;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   var nuevoNumero = resultadosTest.reduce(function(a, b) {
      return a + b;
   })
   var cantidadNotas = resultadosTest.length;
   var resultado = nuevoNumero / cantidadNotas;
   return resultado;
}
...
function cuentoElementos(array) {
   ...
   array.forEach(function (numero) {
      if (numero > 18) {
         contador = contador + 1; // contador += 1 || contador++; ES LO MISMO
      }
   });
   return contador;
}
...
function mayorACien(array) {
   ...
   // Tu código:
   var mayorCien = [];
   array.forEach(function(mayor){
      if (mayor > 100) {
         mayorCien.push(mayor);
      }
   })
   return mayorCien;
}
